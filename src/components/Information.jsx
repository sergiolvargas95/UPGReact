...
const Information = () => (
    <div className="Information">
        ...
        <p>Trabajar en la predicación del evangelio a toda criatura, llevando refrigerio espiritual y físico; </p><p>y que conozcan el plan de salvación que Cristo tiene para sus vidas.</p>
    </div>
);
